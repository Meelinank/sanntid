...
class SpheroServer:
    def __init__(self):
        ...
        self.init_rvr()
        self.setup_sockets()
        self.setup_threading_variables()  # Ensure threading variables are set up early
        self.init_sensor_control()        # Initialize sensor control after threading setup
        self.direction = None
        self.heading = None
        self.speed = None
        self.sensor_data = {}
    ...
    def control_robot(self):
        ...
        try:
            while not self.exit_flag:
                ...
                time.sleep(0.2)  # A short delay to prevent overwhelming the robot with commands
